...
//User config: ***********************************************************************************
	...
	//static IP
	uint8_t myIP[4] = { 192, 168, 1, 71 };     // Roofcontrol module 
	uint8_t gwIP[4] = { 192, 168, 1, 1 };      // Gateway IP also used if Accesspoint created
	uint8_t mask[4] = { 255, 255, 255, 0 };
	uint8_t myDNS[4] = { 192,168,1,1 };// { 8, 8, 8, 8 };         //optional
	uint8_t IPToAOG[4] = { 192,168,1,255 };
